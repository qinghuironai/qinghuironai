<template>
  <div class="list">
    <div
      :key="index"
      class="column"
      v-for="(item, index) in [leftList, rightList]"
    >
      <div
        :key="column.id"
      ...
      >
        <div
          :class="['item-content', { 'isSetu': column.xrestrict === 1 || column.sanityLevel > 6 }]"
        >
          <img
            alt
            v-lazy="PREFIX + column.imageUrls[0].medium"
          />
          <img
            alt
        ...
        <div class="artist">
          <div class="artist-avatar">
            <img
              :src="PREFIX + column.artistPreView.avatar"
