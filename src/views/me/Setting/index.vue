    ...
    >
      <v-card>
        ...
        <v-card-text class="text-center">
          <span>实名认证需认证兑换码（点击认证之前请确认信息准确，概不退款）<br> <a href="https://mall.pixivic.net/product/8.html">支付宝获取</a> <br><a href="https://weidian.com/item.html?itemID=4293143058">微店获取</a></span>
        </v-card-text>
        <v-card-text class="text-center">
          <v-text-field
            v-model="name"
